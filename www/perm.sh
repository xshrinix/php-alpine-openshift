...
sed -i 's#Directory "/var/www/localhost/htdocs"#Directory "/var/www/html/dss"#g' /etc/apache2/httpd.conf
sed -i 's#AllowOverride None#AllowOverride All#' /etc/apache2/httpd.conf
sed -i 's/Listen\ 80/Listen\ ${PORT_NUM}/'  /etc/apache2/httpd.conf
